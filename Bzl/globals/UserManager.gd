...
signal sign_up_failed(code, message: String)
signal sign_in_failed(code, message: String)
...
func on_sign_up_failed(code, message: String):
	emit_signal("sign_up_failed", code, message)
	_active_user = null

func on_sign_in_failed(code, message: String):
