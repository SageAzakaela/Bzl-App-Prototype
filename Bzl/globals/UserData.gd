...
func _ready():
	...
	if FileAccess.file_exists("user://userdata.json"):
		file = FileAccess.open("user://userdata.json", FileAccess.READ)
	else:
		file = FileAccess.open("user://userdata.json", FileAccess.WRITE_READ)
