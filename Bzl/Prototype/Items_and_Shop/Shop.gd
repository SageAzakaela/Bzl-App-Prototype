...
func _ready():
	...
	var data_fragment = load("res://Prototype/Items_and_Shop/ShopItem.tscn").instance()
	...
	var code_crystal_white = load("res://Prototype/Items_and_Shop/ShopItem.tscn").instance()
	...
	var code_crystal_red = load("res://Prototype/Items_and_Shop/ShopItem.tscn").instance()
	...
	var code_crystal_blue = load("res://Prototype/Items_and_Shop/ShopItem.tscn").instance()
	...
	var code_crystal_green = load("res://Prototype/Items_and_Shop/ShopItem.tscn").instance()
	...
	var code_crystal_yellow = load("res://Prototype/Items_and_Shop/ShopItem.tscn").instance()
	...
	var code_crystal_purple = load("res://Prototype/Items_and_Shop/ShopItem.tscn").instance()
